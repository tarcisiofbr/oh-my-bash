...
function _omb_theme_PROMPT_COMMAND(){
  PS1="\n${_omb_prompt_bold_gray}(${_omb_prompt_bold_gray}$CONDA_DEFAULT_ENV${_omb_prompt_bold_gray})${_omb_prompt_bold_gray}-${_omb_prompt_bold_gray}[${_omb_prompt_navy}\@${_omb_prompt_bold_gray}]-"
